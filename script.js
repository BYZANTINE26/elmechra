...
function sendMail(form) {
  ...
  // Email validation: basic but practical check (local@domain.tld)
  ...
  // Phone validation: allow empty OR exactly 10 digits. Strip non-digits then check length.
  ...
  const phone = encodeURIComponent(phoneDigits);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const totalItems = 4; // Total real items (without clones)
